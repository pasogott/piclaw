...
export interface AdministrationSettings {
  ...
  users: {
    ...
    capabilities: { disable: boolean; enable: boolean; change_role: boolean; invite: boolean; revoke_invitation: boolean; reset: boolean; inspect_security: boolean; assign_home: boolean };
  }[];
}
