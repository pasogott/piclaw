...
type RequireReleasedHarnessTool<T extends HarnessTool> = T;
// @ts-expect-error -- contextual v3 tools are not released-v2 HarnessTool values.
type _UnsupportedReleasedToolAssignment = RequireReleasedHarnessTool<AgentHarnessTool<PiclawToolContext>>;
