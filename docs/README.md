...
- [Local note retrieval baseline](performance/local-note-retrieval-baseline.md) — synthetic file-search evaluation, measured limits and proposed release budgets
