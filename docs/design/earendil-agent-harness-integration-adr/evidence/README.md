...
| E-017 | [`alternatives-and-migration.md`](alternatives-and-migration.md) | Architecture comparison and cutover planning | Fixture-first alternative selected; nine reversible phases (`M0`–`M8`), shadow metrics, validation and installed-service gates defined |
