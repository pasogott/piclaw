...
4. adopt Earendil's harness directly and keep only Piclaw service-plane adapters;
5. use the provisional Earendil-shaped fixture, then replace it with the real harness under one contract suite.
